...
- **2026-06-08** — Optimized the Overpass-direct backend: **streaming + vectorization**.
  ...
  - **New follow-up:** migrate `street_selector.py` off the old `osm_downloader.project_and_save` to the new package's projection (edit-time re-projection still uses geopandas).
